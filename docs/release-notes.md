...
Пользователям: скачайте X4.Launcher.zip, распакуйте и откройте X4 Launcher. Выберите бутылку Steam и нажмите «Установить и запустить».

На M4 Max с 48 ГБ владелец подтвердил стабильную игру без артефактов. FPS не измерялся инструментально. Выбранное разрешение 1740×1129. Подробные настройки и ограничения приведены в документации репозитория.
